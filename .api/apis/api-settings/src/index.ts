...
class SDK {
  ...
  constructor() {
    this.core = new APICore(definition, 'api-settings/unknown (api/7.0.0-beta.3)');
  }
   ...
   */
  deleteADealTaskType(metadata: types.DeleteADealTaskTypeMetadataParam): Promise<FetchResponse<200, types.DeleteADealTaskTypeResponse200>> {
